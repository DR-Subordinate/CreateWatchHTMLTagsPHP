...
<tr>
<th width="20%" bgcolor="#EBE8D7" style="padding:8px;border:#dddddd solid 1px;">点検</th>
...
<tr>
<th width="20%" bgcolor="#EBE8D7" style="padding:8px;border:#dddddd solid 1px;">裏蓋</th>
<td width="80%" bgcolor="#ffffff" style="padding:8px;border:#dddddd solid 1px;"><?php echo nl2br($_POST['case-back']); ?></td>
</tr>
<?php endif; ?>
<?php if(!empty($_POST['crystal'])): ?>
<tr>
<th width="20%" bgcolor="#EBE8D7" style="padding:8px;border:#dddddd solid 1px;">風防</th>
...
<tr>
<th width="20%" bgcolor="#EBE8D7" style="padding:8px;border:#dddddd solid 1px;">ブレス・ベルト</th>
<td width="80%" bgcolor="#ffffff" style="padding:8px;border:#dddddd solid 1px;"><?php echo nl2br($_POST['bracelet-strap']); ?></td>
</tr>
<?php endif; ?>
</table>
<br>
