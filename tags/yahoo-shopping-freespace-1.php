...
<tr>
<th width="25%" bgcolor="#EBE8D7" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">シリアル</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['serial']); ?></td>
</tr>
<?php endif; ?>
...
<tr>
<th width="25%" bgcolor="#EBE8D7" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">日差</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['daily-rate']); ?></td>
</tr>
<?php endif; ?>
...
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['accessory']); ?></td>
</tr>
<?php endif; ?>
...
<tr>
<th width="25%" bgcolor="#EBE8D7" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">検索キーワード</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['search-word']); ?>
</td>
</tr>
<?php endif; ?>
...
<tr>
<th width="25%" bgcolor="#EBE8D7" align="center" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">ケース・ベゼル</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['case-bezel']); ?></td>
</tr>
<?php endif; ?>
<?php if(!empty($_POST['case-back'])): ?>
<tr>
<th width="25%" bgcolor="#EBE8D7" align="center" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">裏蓋</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['case-back']); ?></td>
</tr>
<?php endif; ?>
<?php if(!empty($_POST['crystal'])): ?>
<tr>
<th width="25%" bgcolor="#EBE8D7" align="center" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">風防</th>
<td width="75%" bgcolor="#FFFFFF" style="padding:8px; border:#dddddd solid 1px;"><?php echo nl2br($_POST['crystal']); ?></td>
</tr>
<?php endif; ?>
<?php if(!empty($_POST['crown'])): ?>
<tr>
<th width="25%" bgcolor="#EBE8D7" align="center" style="padding:8px; border:#dddddd solid 1px; vertical-align: middle;">リューズ</th>
